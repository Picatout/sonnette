...
Hexadecimal [24-Bits]
                           ...
                           00500F    23     BELL_PORT=PD
                           000000    24     BELL_BIT=0
                                     25 
                                     26     .macro _tone_on
                                     27     bset TIM3_CR1,#TIM_CR1_CEN 
                                     28     .endm
                                     29 
                                     30     .macro _tone_off 
                                     31 	bres TIM3_CR1,#TIM_CR1_CEN 
                                     32     .endm 
                                     33 
                           00500A    34     BTN_PORT=PC 
                           000001    35     BTN_BIT=1 
                                     36 
                                     37     ; enable exti on ring button 
                                     38     .macro _enable_button
                                     39     bset BTN_PORT+GPIO_CR2,#BTN_BIT 
                                     40     .endm 
                                     41 
                                     42     ; disable exti on ring button 
                                     43     .macro _disable_button
                                     44     bres BTN_PORT+GPIO_CR2,#BTN_BIT 
                                     45     .endm 
                                     46 
                           005005    47     LED_PORT=PB 
                           000007    48     LED_BIT=7
                                     49 
                                     50     .macro _led_on 
                                     51     bres LED_PORT,#LED_BIT 
                                     52     .endm 
                                     53 
                                     54     .macro _led_off 
                                     55     bset LED_PORT,#LED_BIT 
                                     56     .endm 
                                     57 
                                     58     .macro _LED_TOGGLE 
                                     59     bcpl LED_PORT,#LED_BIT 
                                     60     .endm 
                                     61 
                                     62 
...
Hexadecimal [24-Bits]
                                     ...
                                     64 
                           000080    65     STACK_SIZE=128
                           0005FF    66     STACK_EMPTY=RAM_SIZE-1 
                                     67 
                                     68 ; boolean flags 
                           000007    69     FTIMER=7 
                                     70 
                                     ...
                                     73 ;-------------------------------------
                                     74 
                                     75     ; assume 16 Mhz Fcpu 
                                     76      .macro _usec_dly n 
                                     77     ldw x,#(16*n-2)/4 ; 2 cy 
                                     78     decw x  ; 1 cy 
                                     79     nop     ; 1 cy 
                                     80     jrne .-2 ; 2 cy 
                                     81     .endm 
                                     82 
                                     83 ;----------------------------------
                                     84 ; functions arguments access 
                                     85 ; from stack 
                                     86 ; caller push arguments before call
                                     87 ; and drop them after call  
                                     88 ;----------------------------------    
                                     89     ; get argument in X 
                                     90     .macro _get_arg n 
                                     91     ldw x,(2*(n+1),sp)
                                     92     .endm 
                                     93 
                                     94     ; store X in argument n 
                                     95     .macro _store_arg n 
                                     96     ldw (2*(n+1),sp),x 
                                     97     .endm 
                                     98 
                                     99     ; drop function arguments 
                                    100     .macro _drop_args n 
                                    101     addw sp,#2*n
                                    102     .endm 
                                    103 
...
Hexadecimal [24-Bits]
      ...
      0005FF                         34 stack_unf:: ; stack underflow ; control_stack bottom 
                                     ...
                                     39 ;;--------------------------------------
                                     40 
      008000 82 00 81 50             41     int reset   			; RESET vector 
...
Hexadecimal [24-Bits]
      ...
      000005                         79 flags:: .blkb 1 ; various boolean flags
      000006                         80 ptr:: .blkw 1 ; score pointer 
                                     81 
      000100                         82 	.org 0x100
      000100                         83 free_ram:: ; from here RAM free for BASIC text 
                                     84 
                                     85 	.area CODE
                                     86 
                                     87 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                     88 ; non handled interrupt 
                                     89 ; reset MCU
                                     90 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
      008080                         91 NonHandledInterrupt:
      008080 80               [11]   92 	iret 
                                     93 
                                     94 ;;;;;;;;;;;;;;;;;;;;;;;
                                     95 ; doorbell button 
                                     96 ; interrupt handler 
                                     97 ;;;;;;;;;;;;;;;;;;;;;;;
      008081                         98 BtnExtiHandler:
      000001                         99 	_disable_button
      008081 72 13 50 0E      [ 1]    1     bres BTN_PORT+GPIO_CR2,#BTN_BIT 
      008085 72 12 50 A3      [ 1]  100 	bset EXTI_SR1,#BTN_BIT ; clear interrupt
      008089 80               [11]  101 	iret 
                                    102 	
                                    103 ;------------------------------
                                    104 ; TIMER 4 is used to maintain 
                                    105 ; a milliseconds 'ticks' counter
                                    106 ; and decrement 'timer' varaiable
                                    107 ; ticks range {0..65535}
                                    108 ; timer range {0..65535}
                                    109 ;--------------------------------
      00808A                        110 Timer4UpdateHandler:
      00808A                        111 0$:
      00808A 72 5F 52 E4      [ 1]  112 	clr TIM4_SR 
      00000E                        113 	_ldxz ticks
      00808E BE 01                    1     .byte 0xbe,ticks 
      008090 1C 00 01         [ 2]  114 	addw x,#1 
      000013                        115 	_strxz ticks 
      008093 BF 01                    1     .byte 0xbf,ticks 
      008095 72 0F 00 05 0B   [ 2]  116 	btjf flags,#FTIMER,1$
      00001A                        117 	_ldxz timer
      00809A BE 03                    1     .byte 0xbe,timer 
      00809C 5A               [ 2]  118 	decw x 
      00001D                        119 	_strxz timer
      00809D BF 03                    1     .byte 0xbf,timer 
      00809F 26 04            [ 1]  120 	jrne 1$ 
      0080A1 72 1F 00 05      [ 1]  121 	bres flags,#FTIMER  
      0080A5                        122 1$:	
      0080A5 80               [11]  123 	iret 
                                    124 
                                    125 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [24-Bits]
                                    ...
                                    131 ; keep it at default 2Mhz 
                                    132 ;----------------------------------------
      0080A6                        133 clock_init:	
                                    134 ;	clr CLK_CKDIVR ; 16Mhz HSI oscillator 
      0080A6 81               [ 4]  135 	ret
                                    136 
                                    137 ;---------------------------------
                                    ...
                                    140 ;----------------------------------
      0080A7                        141 timer4_init:
      0080A7 72 14 50 C3      [ 1]  142 	bset CLK_PCKENR,#CLK_PCKENR_TIM4
      0080AB 72 11 52 E0      [ 1]  143 	bres TIM4_CR1,#TIM4_CR1_CEN 
      0080AF 35 04 52 E7      [ 1]  144 	mov TIM4_PSCR,#4 ; FMSTR/16=125000 hertz  
      0080B3 35 83 52 E8      [ 1]  145 	mov TIM4_ARR,#(256-125) ; 125000/125=1 msec 
      0080B7 35 05 52 E0      [ 1]  146 	mov TIM4_CR1,#((1<<TIM4_CR1_CEN)|(1<<TIM4_CR1_URS))
      0080BB 72 10 52 E3      [ 1]  147 	bset TIM4_IER,#TIM4_IER_UIE
      0080BF 81               [ 4]  148 	ret
                                    149 
                                    150 ;---------------------------------------
                                    151 ; confirugre TIMER3 in PWM mode 
                                    152 ; for sound generation
                                    153 ; output TIMER3:CH2 on mcu pin 5 
                                    154 ;---------------------------------------
      0080C0                        155 timer3_init:
      0080C0 72 12 50 C3      [ 1]  156 	bset CLK_PCKENR,#CLK_PCKENR_TIM3 ; enable TIMER3 clock 
      0080C4 35 60 52 89      [ 1]  157  	mov TIM3_CCMR2,#(6<<TIM_CCMR2_OC2M) ; PWM mode 1 
                                    158 ;	mov TIM3_PSCR,#3 ; FMSTR/8
      0080C8 72 19 52 8A      [ 1]  159 	bres TIM3_CCER1,#TIM_CCER1_CC2E
      0080CC 72 1E 52 94      [ 1]  160 	bset TIM3_BKR,#TIM_BKR_MOE
      0080D0 81               [ 4]  161 	ret 
                                    162 
                                    163 ;---------------------------------------
                                    164 ; configure external interrupt on 
                                    165 ; doorbell button. This wakeup mcu from 
                                    166 ; halt state 
                                    167 ; exti on PC:1, mcu pin 8 
                                    168 ;---------------------------------------
      0080D1                        169 config_exti:
      0080D1 35 08 50 A0      [ 1]  170 	mov EXTI_CR1,#(2<<(2*BTN_BIT)) ; falling edge trigger  
      0080D5 81               [ 4]  171 	ret 
                                    172 
                                    173 
                                    174 ;---------------------
                                    ...
                                    179 ;    none 
                                    180 ;---------------------
      0080D6                        181 delay_msec: 
      000056                        182 	_strxz timer 
...
Hexadecimal [24-Bits]
      ...
      0080D8 72 1E 00 05      [ 1]  183 	bset flags,#FTIMER 
      0080DC 72 0E 00 05 FB   [ 2]  184 1$: btjt flags,#FTIMER,1$
      0080E1 81               [ 4]  185 	ret 
                                    186 
                                    187 ;---------------------
                                    188 ; tone generator 
                                    189 ; use TIMER3 channel 2
                                    190 ; input:
                                    191 ;   Y   frequency (arr value) 
                                    192 ;   x   duration (msec)
                                    193 ;---------------------
                           000001   194 	DIVR=1  ; divisor 
                           000003   195 	DLY_MS=3
                           000004   196 	VSIZE=4 
                           1E8480   197 FR_TIM3=FMSTR 
      0080E2                        198 tone:: 
                           000000   199 .if 0
                                    200 	_vars VSIZE 
                                    201 	ldw (DLY_MS,sp),x   
                                    202 	ldw (DIVR,sp),y  ; divisor  
                                    203 ; FR_TIM3/frequency 
                                    204 	ldw y,#FR_TIM3>>16
                                    205     ldw x,#FR_TIM3 
                                    206     ld a,#17
                                    207 1$: subw y,(DIVR,sp)
                                    208     ccf 
                                    209     jrc 2$
                                    210     addw y,(DIVR,sp)
                                    211     rcf 
                                    ...
                                    216     jrne 1$
                                    217 .endif 
      0080E2 90 9E            [ 1]  218 	ld a,yh 
      0080E4 C7 52 8E         [ 1]  219 	ld TIM3_ARRH,a 
      0080E7 90 9F            [ 1]  220 	ld a,yl 
      0080E9 C7 52 8F         [ 1]  221 	ld TIM3_ARRL,a 
                                    222 ; 50% duty cycle 
      0080EC 90 54            [ 2]  223 	srlw y  
      0080EE 90 9E            [ 1]  224 	ld a,yh 
      0080F0 C7 52 92         [ 1]  225 	ld TIM3_CCR2H,a 
      0080F3 90 9F            [ 1]  226 	ld a,yl
      0080F5 C7 52 93         [ 1]  227 	ld TIM3_CCR2L,a
      0080F8 72 18 52 8A      [ 1]  228 	bset TIM3_CCER1,#TIM_CCER1_CC2E
      0080FC 72 10 52 80      [ 1]  229 	bset TIM3_CR1,#TIM_CR1_CEN
      008100 72 10 52 87      [ 1]  230 	bset TIM3_EGR,#TIM_EGR_UG 	
                                    231 ;	ldw x,(DLY_MS,sp)
      000084                        232 	_tone_on
      008104 72 10 52 80      [ 1]    1     bset TIM3_CR1,#TIM_CR1_CEN 
      008108 CD 80 D6         [ 4]  233 	call delay_msec    
      00810B                        234 tone_off: 
      00008B                        235 	_tone_off 
      00810B 72 11 52 80      [ 1]    1 	bres TIM3_CR1,#TIM_CR1_CEN 
...
Hexadecimal [24-Bits]
      ...
      00810F 81               [ 4]  237 	ret 
                                    238 
      008110                        239 score: ; frenquency (ARR value), duration (msec) 
      008110 09 F7 00 FA            240 	.word 2551,250 ; sol4 
      008114 08 E1 00 FA            241 	.word 2273,250 ; la4 
      008118 0B 2F 00 FA            242 	.word 2863,250 ; fa4 
      00811C 16 5F 00 FA            243 	.word 5727,250 ; fa3 
      008120 0E EE 00 FA            244 	.word 3822,250 ; do4 
      008124 00 00 00 00            245 	.word 0,0 ; end marker 
                                    246 
                                    247 ;-----------------------------
                                    248 ; doorbell play a short tune 
                                    249 ;-----------------------------
                                    250 
      008128                        251 play_tune:
      0000A8                        252 	_led_on 
      008128 72 1F 50 05      [ 1]    1     bres LED_PORT,#LED_BIT 
      00812C AE 81 10         [ 2]  253 	ldw x,#score 
      0000AF                        254 	_strxz ptr 
      00812F BF 06                    1     .byte 0xbf,ptr 
      008131                        255 1$:
      008131 91 CE 06         [ 5]  256 	ldw y,[ptr]
      008134 27 15            [ 1]  257 	jreq 3$
      0000B6                        258 	_ldxz ptr 
      008136 BE 06                    1     .byte 0xbe,ptr 
      008138 1C 00 04         [ 2]  259 	addw x,#4
      0000BB                        260 	_strxz ptr 
      00813B BF 06                    1     .byte 0xbf,ptr 
      00813D 5A               [ 2]  261 	decw x 
      00813E 5A               [ 2]  262 	decw x 
      00813F FE               [ 2]  263 	ldw x,(x)
      008140 CD 80 E2         [ 4]  264 	call tone
      008143 AE 00 41         [ 2]  265 	ldw x,#65
      008146 CD 80 D6         [ 4]  266 	call delay_msec
      008149 20 E6            [ 2]  267 	jra 1$ 
      00814B                        268 3$: 
                                    269 ; end test code 
      0000CB                        270 	_led_off
      00814B 72 1E 50 05      [ 1]    1     bset LED_PORT,#LED_BIT 
      00814F 81               [ 4]  271 	ret 
                                    272 
                                    273 	
                                    274 ;-------------------------------------
                                    275 ;  initialization entry point 
                                    276 ;-------------------------------------
      008150                        277 reset:
                                    278 ;set stack 
      008150 AE 05 FF         [ 2]  279 	ldw x,#STACK_EMPTY
      008153 94               [ 1]  280 	ldw sp,x
                                    281 ; clear all ram 
      008154 7F               [ 1]  282 0$: clr (x)
      008155 5A               [ 2]  283 	decw x 
      008156 26 FC            [ 1]  284 	jrne 0$
                                    285 ; set user BELL sound pin as output 
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (STMicroelectronics STM8), page 25.
Hexadecimal [24-Bits]



      008158 72 10 50 11      [ 1]  286     bset BELL_PORT+GPIO_DDR,#BELL_BIT ; output
      00815C 72 10 50 12      [ 1]  287     bset BELL_PORT+GPIO_CR1,#BELL_BIT ; push pull 
                                    288 ; set LED port as output open drain 
      008160 72 1E 50 07      [ 1]  289 	bset LED_PORT+GPIO_DDR,#LED_BIT
      0000E4                        290 	_led_off 
      008164 72 1E 50 05      [ 1]    1     bset LED_PORT,#LED_BIT 
                                    291 ; init TIMER4 to interrupt at every millisecond
      008168 CD 80 A7         [ 4]  292 	call timer4_init
                                    293 ; init TIMER3, for sound generation 
      00816B CD 80 C0         [ 4]  294 	call timer3_init
                                    295 ; configure EXTI on button 
      00816E CD 80 D1         [ 4]  296 	call config_exti
                                    297 ; enable interrupts	
      008171 9A               [ 1]  298 	rim
      0000F2                        299 	_led_on 
      008172 72 1F 50 05      [ 1]    1     bres LED_PORT,#LED_BIT 
      008176 90 AE 03 E8      [ 2]  300 	ldw y,#1000
      00817A AE 00 96         [ 2]  301 	ldw x,#150
      00817D CD 80 E2         [ 4]  302 	call tone 
      000100                        303 	_led_off    
      008180 72 1E 50 05      [ 1]    1     bset LED_PORT,#LED_BIT 
      008184                        304 1$:
      000104                        305 	_enable_button
      008184 72 12 50 0E      [ 1]    1     bset BTN_PORT+GPIO_CR2,#BTN_BIT 
      008188 8E               [10]  306     halt  	
      008189 CD 81 28         [ 4]  307 	call play_tune 
      00818C 20 F6            [ 2]  308 	jra 1$ 
...
Symbol Table
  ...
  7 config_e   000051 R   |   7 delay_ms   000056 R   |   5 flags      000005 GR
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (STMicroelectronics STM8), page 29.
Hexadecimal [24-Bits]

Symbol Table

  6 free_ram   000100 GR  |   7 play_tun   0000A8 R   |   5 ptr        000006 GR
  7 reset      0000D0 R   |   7 score      000090 R   |   2 stack_fu   00057F GR
  2 stack_un   0005FF GR  |   5 ticks      000001 GR  |   5 timer      000003 GR
  7 timer3_i   000040 R   |   7 timer4_i   000027 R   |   7 tone       000062 GR
  7 tone_off   00008B R
...
Area Table
   ...
   5 DATA1      size      7   flags    8
   6 DATA2      size      0   flags    8
   7 CODE       size    10E   flags    0
